...
df = pd.read_pickle('val_label.pkl')

# For pandas DataFrame, you can use the shape attribute
print(len(df[0]))
...
for dataset in datasets:
    for set in sets:
        ...
        # print(len(data_bone))
        data_joint_bone = np.load('{}_data_joint_bones.npy'.format(set), mmap_mode='r')
